...
class UpdateService {
  ...
  static const _appStoreUrl =
      'https://apps.apple.com/app/id6805330310'; // fixed App Store ID
  ...
  static Future<void> checkAndShowIfRequired(BuildContext context) async {
    try {
      ...
      if (!_needsUpdate(info.version, minVersion)) return;
        ...
        await showDialog(
          ...
          builder: (_) => PopScope(
            ...
            child: AlertDialog(
              ...
              icon: const Icon(Icons.system_update, color: AppColors.primary, size: 40),
