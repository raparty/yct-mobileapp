  ...
  async fetch(request, env) {
    ...
    if (request.method === 'POST' && url.pathname === '/upload') {
      try {
        ...
        return new Response(
          JSON.stringify({ success: true, url: `https://pub-360b7b3324fb4f22bb35e656f476062a.r2.dev/${safe}`, path: safe }),
    ...
    // DELETE /delete — delete file from R2
    ...
    return new Response('YCT Worker OK', { headers: cors });
  }
};
